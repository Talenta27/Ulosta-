    ...
    <?php
			if($_POST['finish']){
				...
				if (!$sql) {
            		...
            		echo 'Total biaya untuk pembelian Produk adalah Rp. '.$total.',- dan biaya bisa di kirimkan melalui Rekening Bank BNI terdekat dengan nomor rekening 123 123 123 123 atas nama Ulosta.<br>';
