...
<div class="slider-wrapper">
	...
	">
	<p style="color: #ffffff; font-size: 65px; margin-top: 130px; margin-left: 260px; font-family: monospace;" >SELAMAT DATANG DI ULOSTA</p>
</div>

<!--menu pada index-->
  <ul class="tp-hd-lft wow fadeInDown animated" data-wow-delay="0.5s">
			<div class="" ="content_top">
				<h3 class="future" style="font-family: cursive; font-size: 18px;">Produk Baru kami</h3><br>
				<div class="container">
					<div class="box_1">
					<div class="">
						<?php
